        ...
        <div class="l-column2">
            <div class="p-search">
                ...
                <?php if (have_posts()) : ?>
                    ...
                    <ul class="p-search__blk">
                        <?php while (have_posts()) : the_post(); ?>
                            <li class="p-search__blk__list">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="p-search__blk__list__thumbnail">
                                        <?php
                                        // サムネイルが設定されているかを確認
                                    ...
                                    <h3 class="p-search__blk__list__ttl">
                                        <?php
                                    ...
                                    <time class="p-search__blk__list__date"><?php the_time("Y/m/d"); ?></time>
                                    <!-- <div class="">
                                    <?php
                                    ...
                                    <p class="p-search__blk__list__txt">
                                        <?php
